        ...
        <div>
            <div className='flex flex-col gap-4 m-5'>
                ...
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    <p className='flex items-center gap-2 text-3xl font-medium text-fuchsia-900'>{profileData.name}</p>
                    ...
                    {/* ----- Doc About ----- */}
                    <div>
                        <p className='flex items-center gap-1 font-medium text-fuchsia-900 mt-3'>About :</p>
                    ...
                    <div className='flex gap-2 py-2'>
                        <p className="text-fuchsia-900 font-medium">Address:</p>
